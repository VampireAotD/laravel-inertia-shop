                            ...
                            <div class="pt-3 flex items-center justify-between">
                                ...
                                <div class="flex items-center justify-center">
                                    ...
                                    <inertia-link
                                            ...
                                            preserve-scroll
                                    >
                                        <svg class="h-7 w-7 fill-current text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    ...
                                    <inertia-link
                                            ...
                                            preserve-scroll
                                    >
                                        <svg class="h-7 w-7 fill-black text-gray-500 hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
