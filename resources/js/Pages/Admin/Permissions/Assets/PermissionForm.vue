        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <input
                    ...
                    id="name" type="text" placeholder="Permission name" autocomplete="off" v-model="form.name">
...
export default {
    ...
    methods: {
        sendRequest() {
            if (this.mode === 'edit') {
                this.form.put(this.$route('admin.permissions.update', {permission: this.form.id}))
            } else {
